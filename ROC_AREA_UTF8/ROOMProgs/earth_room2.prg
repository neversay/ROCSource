...
if rand(50)
	echoat $n 強烈的地震形使地形產生變動，你站不穩住腳，丟進大地的裂縫之中！
	echoaround $n 強烈的地震形使地形產生變動，$R站不穩住腳，丟進大地的裂縫之中！
...
if rand(33)
	...
	if rand(66)
		...
		echoat $r 強烈的地震打得你 [1;32m*** 鮮血直流 ***[m.(331-380)
		echoaround $r 強烈的地震打得$R [1;32m*** 鮮血直流 ***[m.(331-380)
