...
if isfight($n)
	echoat $n 你還在戰鬥中，沒有時間去踏石塊！
else
	echoat $n 當你踏上石塊的時，這裡立即捲起一陣強風！
	echoaround $n 當$N踏上石塊的時，這裡立即捲起一陣強風！
	rcall wind_check
...
if rand(10)
	echoat $r 猛烈的風暴讓你 [1;35m有些擦傷[m!(41-60)
	echoaround $r 猛烈的風暴讓$R [1;35m有些擦傷[m!
	modhmv $r 01.41 60 0
	break
endif
if rand(20)
	echoat $r 猛烈的風暴讓你 [1;35m開始破皮[m!(61-85)
	echoaround $r 猛烈的風暴讓$R [1;35m開始破皮[m!
	modhmv $r 01.61 85 0
	break
endif
if rand(30)
	echoat $r 猛烈的風暴讓你 [1;35m烏青瘀血[m!(86-115)
	echoaround $r 猛烈的風暴讓$R [1;35m烏青瘀血[m!
	modhmv $r 01.86 115 0
	break
endif
if rand(40)
	echoat $r 猛烈的風暴讓你 [1;35m* 烏青瘀血 *[m!(116-150)
	echoaround $r 猛烈的風暴讓$R [1;35m* 烏青瘀血 *[m!
	modhmv $r 01.116 150 0
	break
endif
if rand(50)
	echoat $r 猛烈的風暴讓你 [1;32m* 疼痛不堪 *[m!(151-190)
	echoaround $r 猛烈的風暴讓$R [1;32m* 疼痛不堪 *[m!
	modhmv $r 01.151 190 0
	break
endif
if rand(60)
	echoat $r 猛烈的風暴讓你 [1;32m** 疼痛不堪 **[m!(191-230)
	echoaround $r 猛烈的風暴讓$R [1;32m** 疼痛不堪 **[m!
	modhmv $r 01.191 230 0
	break
endif
if rand(80)
	echoat $r 猛烈的風暴打得你 [1;32m** 尖聲哀叫 **[m!(231-280)
	echoaround $r 猛烈的風暴打得$R [1;32m** 尖聲哀叫 **[m!
	modhmv $r 01.231 280 0
	break
endif
if rand(90)
	echoat $r 猛烈的風暴打得你 [1;32m*** 尖聲哀叫 ***[m!(281-330)
	echoaround $r 猛烈的風暴打得$R [1;32m*** 尖聲哀叫 ***[m!
	modhmv $r 01.281 330 0
	break
endif
if rand(95)
	echoat $r 猛烈的風暴打得你 [1;32m*** 鮮血直流 ***[m.(331-380)
	echoaround $r 猛烈的風暴打得$R [1;32m*** 鮮血直流 ***[m.
	modhmv $r 01.331 380 0
else
	echoat $r 猛烈的風暴打得你 [1;32m**** 鮮血直流 ****[m.(381-450)
	echoaround $r 猛烈的風暴打得$R [1;32m**** 鮮血直流 ****[m.
