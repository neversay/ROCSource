...
const struct social_type social_table[] = {
    {"?", "你露出疑惑的表情。", "$n露出疑惑的表情。", "你對$N露出疑惑的表情。",
     "$n對$N露出疑惑的表情。", "$n對你露出疑惑的表情。", "", ""},
    {"--", "你露出\"-_-\"的表情。", "$n露出\"-_-\"的表情。",
     "你對$N露出\"-_-\"的表情。", "$n對$N露出\"-_-\"的表情。",
     "$n對你露出\"-_-\"的表情。", "你對自己露出\"-_-\"的表情。",
     "$n對自己露出\"-_-\"的表情。"},

    {"accuse", "Accuse 誰？", "", "你不懷好意的盯著$N瞧。",
     "$n不懷好意的盯著$N瞧。", "$n不懷好意的盯著你瞧。", "你感到良心不安。",
     "$n看起來良心不安。"},

    {"ack", "你露出一付「那會按呢」的表情。", "$n露出一付「那會按呢」的表情。",
     "", "", "", "", ""},

    {"addoil", "你對所有人大喊：「加油！」", "$n對所有人大喊：「加油！」",
     "你向$N大喊：「加油！」", "$n向$N大喊：「加油！」",
     "$n對你大喊：「加油！」", "你替自己加油打氣。", "$n對自己說：「加油！」"},

    {"agree", "你完全同意。", "$n完全同意。", "你完全同意$N的看法。",
     "$n完全同意$N的看法。", "$n完全同意你的看法。",
     "你對自己的看法感到很自豪。", "$n對$e自己的看法感到很自豪。"},
    {// by chinko@ROC
     "aluba", "你要阿魯巴誰？",
     //"$n正虎視眈眈的尋找獵物中。",
     ...
     "$n把$N拖過去, 單腳猛往他的跨下踩, $N這下糟了！", "你瘋了嗎？",
     "$n正在對自己做自助式阿魯巴！這？"},

    {"angry", "你露出一付很生氣的表情。", "$n露出一付很生氣的表情。",
     "你生氣地瞪著$N。", "$n生氣地瞪著$N。", "$n生氣地瞪著你。",
     "你對自己的愚蠢行為感到很生氣。", "$n對自己的愚蠢行為感到很生氣。"},

    {"applaud", "你興奮地鼓掌.", "$n興奮地鼓掌.", "你對著$N鼓掌喝采！",
     "$n對著$N鼓掌喝采.", "$n對你鼓掌喝采，你一定是做了什麼了不起的事。",
     "對自己鼓掌？你很了不起嗎？", "$n對著$e自己鼓掌，好像以為自己很了不起。"},

    {"bark", "你叫了一聲「汪」！", "$n學狗叫了一聲「汪」。", "你對$N大聲咆哮。",
     "$n對$N大聲咆哮。", "$n對你大聲咆哮。", "你對著自己學狗叫，「汪」「汪」！",
     "$n對著$e自己學狗叫。"},

    {"beer", "你拿起一杯冰啤酒，仰頭一飲而盡，哇…好爽！",
     "$n拿起一杯冰啤酒，抬頭一口氣喝乾，臉上露出滿足的表情。",
     "你恭敬地替$N倒了一杯清涼的冰啤酒。", "$n恭敬地替$N倒了一杯冰涼的啤酒。",
     "$n恭敬地替你倒了一杯冰啤酒。", "你替自己倒了一杯酒。",
     "$n替$e自己倒了一杯酒。"},

    {"beg", "你可憐兮兮的叫道：「好心的帥哥、美女～請施捨我幾塊錢吧～」",
    ...
    {"zc", "你在空中快速的比劃了幾下，口裡喃喃念著：「Zc退散！BG不要來！」",
     ...
     "$n試著讓$m遠離Zc的詛咒，可是看來......"},
    {"masterAsia", "你用最大力氣宣揚東方不敗流",
     "$n放聲大喝：「流派，東方不敗乃王者之風！」",
     "你對著$N大喝：「你這個笨蛋弟子！」", "$n對著$N大喝：「你這個笨蛋弟子！」",
     "$n大聲以師父的身份的斥責你，讓你一頭霧水",
     "你相信自己的東方不敗流是最強的",
     "$n對著自己說：「我是東方不敗！我是最強的！」"},
    {"richman", "你用力在背包裡翻找，拿出了一副大富翁，吆喝著大家來玩。",
    ...
    {"boring", "你向天吶喊道：「天啊！怎麼這麼無聊啊！！」",
     "$n向天大喊：「好無聊啊！！」", "你懶洋洋地對$N說：「很無聊耶...」",
     "$n懶洋洋地對$N說：「很無聊耶...」", "$n懶洋洋地對你說：「很無聊耶...」",
     "你因為太無聊沒有事情做，雙眼無神的盯著前方。",
     "$n因為太無聊沒有事情做，雙眼無神的坐在那邊。"},
    {"shining", "你的眼睛突然冒出了異樣的光芒！",
     "$n的眼神突然出現了異樣的光芒！彷彿發現了什麼！",
     "你發現了$N的秘密了！嘿嘿嘿嘿！", "$n似乎發現了什麼，詭異地盯著$N瞧個不停",
     "$n閃亮的雙眼盯著你直直看，讓你渾身不自在！",
     "你發現了一些不為人知的祕密！", "$n似乎發現了什麼祕密！喔喔喔喔！"},
    {
        "wc",
        "你不好意思地對大家說：「對不起，我去上個洗手間！」。",
        "$n不好意思地對大家說：「對不起，我去上個洗手間！」，然後急急忙忙的跑開"
        "了。",
        "你尷尬地對$N說：「上個廁所！等我一下喔。」",
        "$n尷尬地對$N說：「上個廁所！等我一下喔。」",
        "$n尷尬地對你說：「上個廁所！等我一下喔。」",
    ...
    },
    {
        ...
        "你一手拍著$N的肩膀，一手在胸前劃個十字對$"
        "N說道：上帝會原諒你的～阿門～",
        "$n一手拍在$N的肩膀，一手在胸前劃個十字對$"
        "N說道：上帝會原諒你的～阿門～",
    ...
    {"meow",
     ...
     "你像隻可愛的招財貓在那揮著貓爪。", "$n像隻可愛的招財貓在那揮著貓爪。"},
    {
        "newbie",
    ...
    {"bingo", "你高興的大叫：「Ｂｉｎｇｏ～」",
     "$n高興的大叫：「Ｂｉｎｇｏ～」", "你興奮地對$N說：「恭喜你中獎了！」",
     "$n興奮地對$N說：「恭喜你中獎了！」", "$n興奮地對你說：「恭喜你中獎了！」",
     "", ""},

    {"bite", "Bite 誰？", "", "你張開血盆大口，往$N狠狠地咬了一口！",
     "$n張開血盆大口，往$N狠狠地咬了一口。",
     "$n張開血盆大口，往你狠狠地咬了一口！", "你餓得發慌，於是咬了自己一口。",
     "$n咬了自己一口，是不是餓壞了？"},
    {"blatant", "你痛苦的摀住眼大叫：「閃光！是閃光啊！」",
     "$n痛苦的摀住眼大叫：「閃光！是閃光啊！」",
     "你痛苦的對著$N說：「好刺眼的光芒啊！」",
     "$n痛苦的對著$N說：「太刺眼了！我瞎了！」",
     "$n痛苦的對著你說：「好刺眼的光芒啊！」",
    ...
    {// by chinko@ROC
     ...
     "$n的真心祝福你能一切順利呦！", "Oh！God Bless Me～",
     "$n對於自己的未來懷著滿心的期許\ 。"},

    {"blush", "你的臉害羞的紅了起來！", "$n的臉害羞的紅了起來！",
     "你一見到$N，馬上臉紅著害羞跑開了。", "$n一見到$N，馬上臉紅著害羞跑開了。",
     "$n一見到你，馬上臉紅著害羞跑開了。", "你對自己的行為感到羞恥。",
     "$n對$e的行為感到羞恥。"},

    {"bounce", "你高興地蹦蹦跳跳。", "$n像個小孩子一樣地蹦蹦跳跳。",
     "你高興地跳到$N的身上。", "$n高興地跳到$N的身上。",
     "$n高興地跳到你的身上。", "", ""},

    {"bow", "你優雅的欠身鞠躬。", "$n優雅的欠身鞠躬。", "你向$N深深一鞠躬。",
     "$n向$N深深一鞠躬。", "$n對你深深一鞠躬。", "", ""},
    /*
        {
            "burp",
    ...
    */
    {"bye", "你對大家揮手說再見！", "$n對大家揮手說再見！",
     "你向$N說道：「走好，不送了。」", "$n向$N說道：「走好，不送了。」",
     "$n對你說道：「走好，不送了。」", "", ""},

    {"cackle", "你很酷地仰起頭，尖聲地狂笑起來！",
     "$n很酷地仰起頭，尖聲地狂笑起來！", "你對$N尖聲狂笑。", "$n對$N尖聲狂笑。",
     "$n對你尖聲狂笑著。 你最好離$m遠一點。", "你像發了瘋般地對自己尖聲狂笑。",
     "$n對著自己尖聲狂笑，看起來好像不太對勁。 "},

    {"chuckle", "你輕輕地笑了一聲。", "$n 輕輕地笑了一聲。",
     "你對著$N輕輕地笑了一聲。 ", "$n對著$N輕輕地笑了一聲。",
     "$n對著你輕輕地笑了一聲。", "", ""},

    {
        "clap", "你興奮地鼓掌.", "$n興奮地鼓掌.", "你對$N鼓掌喝采！",
        "$n對$N鼓掌喝采.", "$n對你鼓掌喝采，你一定是做了什麼了不起的事。",
        "對自己鼓掌？你很了不起嗎？", "$n對著$e自己鼓掌，好像以為自己很了不起。"
    ...
    */
    ...
    {"cringe", "你害怕的直發抖！", "$n害怕的直發抖。", "你害怕$N而發抖。",
     "$n害怕$N而發抖。", "$n對著你直發抖，看起來好像很怕你。",
     "你覺得自己長得很可怕嗎？", ""},

    {"cry", "你放聲大哭，哇～～～", "$n放聲大哭。",
     "你靠在$N的肩膀上，放聲大哭。", "$n靠在$N的肩膀上，放聲大哭。",
     "$n靠在你的肩膀上，放聲大哭。", "你不停地哭哭啼啼。",
     "$n不停地哭哭啼啼。"},

    {"cuddle", "cuddle 誰？", "", "你熱情地擁抱著$N。", "$n熱情地擁抱著$N。",
     "$n熱情地擁抱著你。", "你雙手環抱，沉醉在自己的世界裡。",
     "$n雙手環抱，沉醉在自己的世界裡。"},
    ...
    {"curtsey", "你對在場的所有人福了一福。", "$n對所有人福了一福。",
     "你對$N躬身福了一福。", "$n對$N躬身福了一福。", "$n對你躬身福了一福。", "",
     ""},

    {"dance", "你高興的跳起舞來！", "$n高興的跳起舞來！",
     "你拉著$N的手，高興的跳起舞來！", "$n拉著$N的手，高興的跳起舞來！",
     "$n拉著你的手，高興的跳起舞來！", "", ""},

    {"die", "你死了。", "$n死了。", "你吐出一口鮮血，死在$N的懷裡。",
     "$n吐出一口鮮血，死在$N的懷裡。", "$n吐出一口鮮血，死在你的懷裡。",
     "你囂張地說道：「來呀，來殺我呀～」",
     "$n囂張地說道：「來呀，來殺我呀～」"},

    {"disagree", "你完全不同意。", "$n完全不同意。", "你完全不同意$N的看法。",
     "$n完全不同意$N的看法。", "$n完全不同意你的看法。",
     "你認為自己的看法完全錯誤。", "$n認為$e自己的看法完全錯誤。"},
    {"dive", "你找了個地洞鑽了進去。", "$n找了個地洞鑽了進去。",
     "你鑽進$N的懷裡撒嬌。", "$n鑽進$N的懷裡撒嬌。", "$n鑽進你的懷裡撒嬌。",
     "你想盡辦法把自己的頭埋進土裡。",
     "$n在地上挖了個洞，然後把自己的頭埋進去。"},
    {"domon", "你熱血沸騰地說：「我的手中正火紅燃燒著!!」",
     "$n熱血地說：「我的手中正火紅燃燒著!!」",
     "你向$N熱血地說：「看我的 GOD~~~ FINGER~~~ !!」, "
     "$N被擊中後開始全身燃燒著。",
     "$n向$N熱血地說：「看我的 GOD~~~ FINGER~~~ !!」, "
     "$N被擊中後開始全身燃燒著。",
     "$n對你熱血地說：「看我的 GOD~~~ FINGER~~~ !!」, "
     "你被擊中後開始全身燃燒著。",
    ...
    {"drunk", "你喝得醉醺醺的，挺個大肚子，打了個嗝，「呃～～」。",
     "$n喝得醉醺醺的，挺個大肚子，「呃」的一聲打了個嗝。",
     "你用關心的語氣對$N說：「孩子，你醉了。」",
     "$n用關心的語氣對$N說：「孩子，你醉了。」",
     "$n用關心的語氣對你說：「孩子，你醉了。」", "", ""},
    {// by sword@ROC
     "duel", "你大聲的怒吼︰「是誰！？有種就出來決一生死！」",
     "$n大聲的怒吼：「是誰！？有種就出來決一生死！」",
    ...
    {"envy", "你眼中流露出羨慕的眼神！", "$n的眼裡流露出羨慕的眼神！",
     "你羨慕地盯著$N瞧個不停", "$n羨慕地盯著$N瞧個不停",
     "$n羨慕地盯著你直直瞧，讓你感覺毛骨聳然！", "你自豪地說著：怎樣！羨慕吧！",
     "$n自豪地說著：怎樣！羨慕吧！嘿嘿嘿！"},

    {"eyebeam", "你的眼睛射出怪異的光線朝四周掃射。",
    ...
    {"faint", "你口吐白沫，昏倒在地上。", "$n口吐白沫，「咚」的一聲昏倒在地。",
     "你昏倒在$N的懷裡。", "$n昏倒在$N的懷裡。", "$n昏倒在你的懷裡。", "", ""},

    {"fakerep",
     "你的狀態：30059/30059點生命力、30611/30582點魔法力、30130/"
     "30130點移動力、13500000點經驗值。",
     "$n的狀態：30059/30059點生命力、30611/30582點魔法力、30130/"
     "30130點移動力、13500000點經驗值。",
     "", "", "", ""},
    ...
    {"fear", "你害怕的直發抖。", "$n害怕的直發抖。",
     "你對著$N說：「哈哈～怕了吧。」", "$n對著$N說：「哈哈～怕了吧。」",
     "$n對著你說：「哈哈～怕了吧。」",
     "你瘋狂笑道：「怕我啊，我最喜歡別人怕我了！」",
     "$n瘋狂笑道：「怕我啊，我最喜歡別人怕我了！」"

    },
    {"five", "你高舉著手，不知道要幹什麼。", "$n高舉著手，不知道想幹嘛？",
     "你高興的和$N打了個五。", "$n高興的和$N打了個五。",
     "$n高興的和你打了個五。", "你對其他人說：「Hey! Give me FIVE !!」",
    ...
    */
    {"flop", "你撲通的跌了一跤。", "$n撲通的跌了一跤。",
     "你一個不小心，跌倒在$N的懷裡。", "$n一個不小心，跌倒在$N的懷裡。",
     "$n一個不小心，跌倒在你的懷裡。", "", ""},

    {"fondle", "fondle 誰？", "$n的雙手在空中亂揮，臉上露出邪惡的表情。",
     "你深情地愛撫著$N。", "$n深情地愛撫著$N。", "$n深情地愛撫著你",
     "你用雙手在自己身上摸來摸去。", "$n用雙手在$e自己身上摸來摸去。"},
    /*
        {
            "french",
            "Kiss whom?",
    ...
    */
    {// by skalt@ROC
     "forget", "你滿臉呆滯的環顧四周，像得了失憶症般",
     "$n滿臉呆滯的環顧四周，像得了失憶症般",
     "你裝傻似的對$N說：「你在說什麼，我不記得這回事啊」",
     "$n裝傻似的對$N說：「你在說什麼，我不記得這回事啊」",
     "$n裝傻似的對你說：「你在說什麼，我不記得這回事啊」",
     "你試著回憶起自己遺忘的姓名。", "$n喃喃唸著：「我是誰....我到底是誰><」"},

    {"frown", "你懊惱的皺起眉頭。", "$n懊惱的皺起眉頭。",
     "你對著$N皺起了眉頭。", "$n對著$N皺起了眉頭。", "$n對著你皺起了眉頭。", "",
     ""},
    /*
        {
            "fume",
    ...
    */
    {"gasp", "你驚訝的說不出話來。", "$n驚訝的說不出話來。",
     "你對$N的所作所為感到很訝異。", "$n對$N的所作所為感到很訝異。",
     "$n對你的所作所為感到很訝異。",
     "你搔搔頭，覺得自己的所作所為真是莫名奇妙。",
     "$n搔搔頭，覺得$e自己的所作所為真是莫名奇妙。"},

    {"gf", "你望空大喊：「神啊～賜我一個女朋友吧～」",
     "$n望空大喊：「神啊～賜我一個女朋友吧～」",
    ...
    {"giggle", "你格格的笑了起來。", "$n格格的笑了起來。", "你對著$N格格的笑。",
     "$n對著$N格格的笑。", "$n對著你格格的笑。", "", ""},

    {"glare", "你抬起頭，痴痴地望著天空。", "$n抬起頭，痴痴地望著天空。",
     "你睜大眼睛，盯著$N瞧個不停。", "$n睜大眼睛，盯著$N瞧個不停。",
     "$n睜大眼睛，盯著你瞧個不停。", "你沒辦法看到自己。", ""},

    {"god", "你突然覺得這世界上一定有神的存在。",
     "$n突然覺得這世界上一定有神的存在。",
     "你突然覺得$N簡直跟神一樣，你對著$E不停地跪拜。",
     "$n突然覺得$N簡直跟神一樣，$e對著$E不停地跪拜。",
     "$n突然覺得你簡直跟神一樣，$e對著你不停地跪拜。",
     "你突然覺得你簡直跟神一樣", "$n突然覺得$e簡直跟神一樣"},

    {"good", "你大聲地說：「幹的好！」", "$n大聲地說：「幹的好！」",
     "你大聲地對著$N說：「好！」", "$n大聲地對著$N說：「好！」",
     "$n大聲地對著你說：「好！」", "你覺得自己真是了不起。",
     "$n覺得自己真是了不起。"},

    {"grin", "你露出邪惡的笑容。", "$n露出邪惡的笑容。",
     "你對$N露出邪惡的笑容。", "$n對$N露出邪惡的笑容。",
     "$n對你露出邪惡的笑容.. 你最好提高警覺喔!!", "", ""},

    {"groan", "你輕輕的呻吟著。", "$n輕輕的呻吟著。", "你對著$N輕輕的呻吟著。",
     "$n對著$N輕輕的呻吟著。", "$n對著你輕輕的呻吟著。", "", ""},
    /*
        {
            "grope",
    ...
    */
    {"growl", "你望空高喊，「喔嗚～」", "$n望空高喊，「喔嗚～」",
     "你哼了一聲，說：「可惡的$N，看招！」",
     "$n對$N生氣的哼了一聲，看來馬上就有一場惡鬥。",
     "$n對著你說：「可惡的傢伙，看招！」", "你亂吼亂叫，心情舒服了一點。",
     "$n對著$e自己亂吼亂叫，真是莫名奇妙。"},

    {"grumble", "你不停地抱怨著。", "$n不停地抱怨著。",
     "你對著$N不停地抱怨著。", "$n對著$N不停地抱怨著。",
     "$n對著你不停地抱怨著。", "", ""},
    /*
        {
            "grunt",
    ...
    */
    {"hand", "和誰握手？", "", "你走向$N，和$E用力的握著手。",
     "$n走向$N，和$E用力的握著手。", "$n走了過來，和你用力的握著手。",
     "你無聊的玩著自己的雙手。", "$n無聊的玩著$e自己的手。"},
    /*
        {
            "hangover",
            "You pop a few aspirin and put on your sunglasses.  Ow, your head
       hurts!",
            "$n holds $s head and says 'Quit breathing so loud!'",
            "Won't $N be quiet?  Your head is gonna split in two if $E keeps
       talking!",
    ...
    */
    ...
    {"hate", "你咬牙切齒，說道：「我好恨～我好恨～」",
     "$n咬牙切齒，說道：「我好恨～我好恨～」",
     "你把$N推開，生氣地說：「我恨你！」", "$n把$N推開，生氣地說：「我恨你！」",
     "$n把你推開，生氣地說：「我恨你！」",
     "你瘋狂地笑道：「恨我呀，我最喜歡別人恨我了！」",
     "$n瘋狂地笑道：「恨我呀，我最喜歡別人恨我了！」"},

    {"hehe", "你「嘿嘿嘿～」地奸笑了幾聲。", "$n「嘿嘿嘿～」地奸笑了幾聲。",
     "你「嘿嘿嘿～」地對$N奸笑了幾聲。", "$n「嘿嘿嘿～」地對$N奸笑了幾聲。",
     "$n「嘿嘿嘿～」地對你奸笑了幾聲。", "", ""},

    {"hello", "你興奮地對所有人打招呼！", "$n興奮地對所有人打招呼！",
     "你興奮地對$N說：「嗨！」", "$n興奮地對$N說：「嗨！」",
     "$n興奮地對你說：「嗨！」", "", ""},
    ...
    /*
...

        {
            ...
            "$n jumps in the air by $mself.	 Is $e a cheerleader, or just
       daft?", "You jump in the air and give $M a big highfive!",
            ...
            "$n jumps in the air and gives $mself a big highfive!  Wonder what
       $e did?"
        },

        {
          ...
          "$n has to hold $mself up $e's so tired. $e should go to bed and get
       some sleep."
        },
    */
    {"hmm", "你「嗯」的一聲，一副欲言又止的樣子。",
     "$n「嗯」的一聲，一副欲言又止的樣子。", "你對$N「嗯」了一聲。",
     "$n對$N「嗯」了一聲。", "$n對你「嗯」了一聲。", "", ""},

    {"hop", "你高興的像個小孩子般地蹦蹦跳跳。",
     "$n高興的像個小孩子般地蹦蹦跳跳。", "你高興地跳到$N的身上。",
     "$n高興地跳到$N的身上。", "$n高興地跳到你的身上。", "", ""},
    /*
        {
            "howl",
    ...
    /*
...

        {
          ...
          "$n stuffs an ice cube down $N's shirt, better hope that was $s last
       ice cube.",
          "$n stuffs an ice cube down your shirt. Brrr! $n laughs as you
       struggle to get it out.", "You stick an ice cube down your shirt. Brrr!",
...

        {
            ...
            "$n tells you, 'Voulez-vous couche avec moi ce soir?'",
            "You speak your best French in hopes of getting lucky, with
       yourself???",
            "$n says to $mself, 'Voulez-vous couche avec moi ce soir?'"
        },
      */
    {"idiot", "你不屑地說：「哼！一群白痴。」",
     "$n不屑地說：「哼！一群白痴。」", "你對$N說：「你真是一個大白痴！」",
     "$n對$N說：「你真是一個大白痴！」", "$n對你說：「你真是一個大白痴！」",
     "你流著口水，傻笑著說：「我是白痴～我是白痴啊～」",
     "$n流著口水，傻笑著說：「我是白痴～我是白痴啊～」"},

    {"idle", "你坐在地上，怔怔地發起呆來了。", "$n坐在地上，怔怔地發起呆來了。",
     "", "", "", "", ""},

    {"inn", "你覺得自己好委曲。", "$n覺得自己好委曲。",
     "你眼中充滿淚水，無辜地望著$N。", "$n眼中充滿淚水，無辜地望著$N。",
     "$n眼中充滿淚水，無辜地望著你。", "你覺得自己是世界上最純真的人。",
     "$n覺得自己是世界上最純真的人。"},

    {"kickass", "你練習劈腿。", "$n自己在練習劈腿。",
     "你朝著$N的屁股，狠狠踢下去！", "$n朝著$N的屁股，狠狠踢下去！",
     "$n朝著你的屁股狠狠踢下去，哇，好痛啊！",
     "你用腳後跟踢自己的屁股，真無聊。",
     "$n用腳後跟踢自己的屁股，看來是無聊瘋了。"},

    {"kiss", "Kiss 誰？", "", "你深情地看著$N，給了$E深深的一吻。",
     "$n深情地看著$N，給了$E深深的一吻。", "$n深情地看著你，給了你深深的一吻。",
     "你親了一下自己的手。", "$n親了一下$e自己的手。"},

    {"kok", "你的手高高舉起，好像打算敲什麼東西。",
     "$n的手高高舉起，好像打算敲什麼東西。",
    ...
    {"laugh", "你倒在地上，抱著肚子笑的滾來滾去。",
     "$n倒在地上，抱著肚子笑的滾來滾去。", "你指著$N的鼻子大笑。",
     "$n指著$N的鼻子大笑。", "$n指著你的鼻子大笑。", "你對著自己不停的傻笑。",
     "$n對著$e自己不停的傻笑。"},

    {"lean", "lean 誰？", "", "你像隻小貓般地依偎在$N的懷裡。",
     "$n像隻小貓般地依偎在$N的懷裡。", "$n像隻小貓般地依偎在你的懷裡。", "",
     ""},

    {"leave", "你急急忙忙地離開了。", "$n急急忙忙地離開了。",
     "你飛也似地逃離$N的身旁。", "$n飛也似地逃離$N的身旁。",
     "$n飛也似地逃離你的身旁。", "", ""},

    {"lick", "你舔了舔自己的嘴脣。", "$n舔了舔$e自己的嘴脣。",
     "你舔了舔$N的臉，弄得$E滿臉口水，好噁哦～",
     "$n舔了舔$N的臉，弄得$E滿臉口水，好噁哦～",
     "$n舔了舔你的臉，弄得你滿臉口水，好噁哦～", "你舔了舔自己的手。",
     "$n舔了舔$e的手。"},
    /*
        {
          "listen",
          ...
          "You pay close attention to what you are saying, trying to avoid
       saying something you shouldn't.",
          "$n listens intently to $mself. $e must enjoy the sound of $s own
       voice."
        },
    */
    {"lonely", "你露出落寞的神情。", "$n露出落寞的神情。",
     "你對$N說：「HEY！你寂寞嗎？」", "$n對$N說：「HEY！你寂寞嗎？」",
     "$n對你說：「HEY！你寂寞嗎？」", "你忽然覺得自己好孤單！",
     "$n忽然覺得自己好孤單！"},
    ...
    {"love", "Love 誰？", "", "你深情的對著$N說：「我愛你～此情永不移～」",
     "$n深情的對著$N說：「我愛你～此情永不移～」",
     "$n深情的對著你說：「我愛你～此情永不移～」", "", ""},
    /*
        {
    ...
    */
    {"massage", "Massage 誰？", "$n伸出雙手在空中亂抓。",
     "你替$N按摩，把$E弄得很舒服。", "$n替$N按摩，把$E弄得很舒服。",
     "$n替你按摩，啊～真舒服～", "", ""},
    /*
        {
            "meow",
            "MEOW.",
            "$n meows.  What's $e going to do next, wash $mself with $s
       tongue?", "You meow at $M, hoping $E will give you some milk.",
    ...
    */
    {"miss", "Miss 誰？", "$n就連要想念誰也不知道。",
     "你熱情的衝向$N，對$E說：「好久不見，送你高崗屋。」",
     "$n熱情的衝向$N，對$E說：「好久不見，送你高崗屋。」",
     "$n熱情的衝了過來，對你說：「好久不見，送你高崗屋。」", "", ""},

    {"mmm", "mmmmmmmmmm.......", "$n說道 'mmMMmmMMmmMMmm.'",
     "你對$N說道 'mmMMmmMMmmMMmm.'", "$n對$N說道 'mmMMmmMMmmMMmm.'",
     "$n對你說道 'mmMMmmMMmmMMmm.'", "", ""},

    {"moan", "你慘叫一聲，對自己的錯誤感到懊惱。",
     "$n慘叫一聲。露出一副很懊惱的表情。", "", "", "", "", ""},

    {"monster", "你驚慌地大叫：「怪物來啦～快逃命啊～」",
     "$n驚慌地大叫：「怪物來啦～快逃命啊～」",
     "你對著$N驚慌地大叫：「怪物來啦～救命啊～」",
     "$n對著$N驚慌地大叫：「怪物來啦～救命啊～」",
     "$n對著你驚慌地大叫：「怪物來啦～救命啊～」",
     "你穿上怪物裝，出來嚇無辜的路人。", "$n穿上怪物裝，出來嚇無辜的路人。"},
    /*
        {
            "mooch",
    ...
    {"morning", "你很有朝氣地對著大家說：「早 安 ~」",
     "$n很有朝氣地對著大家說：「早 安 ~」", "你開心地對著$N說一聲早",
     "$n開心地對$N說：「早 安 ~」", "$n開心地對你說聲早安",
    ...
    /*
...

        {
            ...
            "$n grabs $s black hat and sparkly glove and moonwalks across the
       room.", "You grab your hat and moonwalk across the room.",
            "$n grabs $s black hat and sparkly glove and moonwalks across the
       room.",
            "$n grabs $s black hat and sparkly glove and moonwalks across the
       room.", "You grab your hat and moonwalk across the room.",
    ...
    */
    {"nibble", "Nibble 誰？", "", "你輕輕地咬著$N的耳朵。",
     "$n輕輕地咬著$N的耳朵。", "$n輕輕地咬著你的耳朵。", "你咬不到自己的耳朵。",
     ""},

    {"no!", "你絕望地對天大叫：「不～」", "$n絕望地對天大叫：「不～」",
     "你對$N叫道：「不要啊～你不可以這樣啊～」",
     "$n對$N叫道：「不要啊～你不可以這樣啊～」",
     "$n對你叫道：「不要啊～你不可以這樣啊～」",
     "你叫道：「不要～不要～不要停～」", "$n叫道：「不要～不要～不要停～」"},

    {"nod", "你點了點頭。", "$n點了點頭。", "你對$N點了點頭。",
     "$n對$N點了點頭。", "$n對你點了點頭。", "", ""},
    /*
        {
          "noogie",
    ...
    */
    {"nuzzle", "Nuzzle 誰？", "", "你用鼻子在$N的身上蹭來蹭去。",
     "$n用鼻子在$N的身上蹭來蹭去。", "$n用鼻子在你的身上蹭來蹭去。", "", ""},
    /*
        {
            "ogle",
    ...
    */
    ...
    {"ooo", "你蹲在牆角，滿臉委屈地在地上畫圈圈。",
     "$n蹲在牆角，滿臉委屈地在地上畫圈圈。",
     "你蹲在牆角，背對著$N在地上畫圈圈。", "$n蹲在牆角，背對著$N在地上畫圈圈。",
     "$n蹲在牆角，背對著你在地上畫圈圈。", "", ""},
    {"opost", "你痛苦的抱著頭仰天長嘯：「老梗！！這是一個老梗啊！」",
     ...
     "你驚疑不定的喃喃自語：「我又老梗了嗎.....？」",
     "$n驚疑不定的喃喃自語：「我又老梗了嗎.....？」"},
    {"orz", "你一時無法接受這個打擊，失意的彎下身去 Ｏｒｚ ",
     "$n似乎受到很大的傷害，灰暗的將身體彎曲成 Ｏｒｚ 的姿勢",
     "你發現自己跟$N的水準實在差太多了，不自禁的擺出了 Ｏｒｚ 的姿勢",
     "$n發現自己跟$N的水準實在差太多了，不自禁的擺出了 Ｏｒｚ 的姿勢",
     "$n發現自己跟你的水準實在差太多了，只得擺出敗者標誌 Ｏｒｚ ，哇哈哈",
     "你傷心難過痛苦不堪的，擺出了失意體前彎的動作 Ｏｒｚ ",
     "$n傷心難過痛苦不堪的，擺出了失意體前彎的動作 Ｏｒｚ "},
    {"ouch", "你大叫：「好痛啊～痛死人啦～」", "$n大叫：「好痛啊～痛死人啦～」",
     "", "", "", "你痛的在地上打滾。", "$n痛的在地上打滾。"},

    {"pat", "Pat 誰？", "", "你輕輕拍拍$N的頭。", "$n輕輕拍拍$N的頭。",
     "$n輕輕拍拍你的頭。", "你摸摸自己的頭。", "$n摸摸$e自己的頭。"},
    {"pig", "你說：「好豬哦！」", "$n說：「好豬哦！」",
     "你覺得$N簡直笨的像頭豬。", "$n覺得$N簡直笨的像頭豬。",
     "$n覺得你簡直笨的像頭豬。", "你覺得自己笨的像頭豬。",
     "$n覺得自己笨的跟豬一樣。"},
...
*/
    {// by Zeel@ROC
     "pili", "你被突如其來的閃電打的全身漆黑！", "$n召喚天雷進行無差別攻擊！",
     "你把$N打的漆黑一片！", "$n召喚天雷把$N打得是漆黑一片！",
     "$n對你施放天雷召喚，打得你漆黑一片！", "你試著召喚天雷攻擊自己。",
     "$n試著對自己施以雷電攻擊？"},
    {"pk", "你像發了瘋般的大叫：「那一個不要命的，給我滾出來！」",
    ...
    {"point", "Point 誰？", "", "你指著$N。", "$n指著$N。", "$n指著你。",
     "你指著自己。", "$n指著$e自己。"},

    {"poke", "Poke 誰？", "", "你無聊地戳了$N一下。", "$n無聊地戳了$N一下。",
     "$n無聊地戳了你一下。", "你戳了你自己一下。", "$n戳了$e自己一下。"},

    /* I will use 'think' to replace 'ponder'   */
    {"ponder", "你低頭沉思.", "$n 低頭沉思.", "你認真考慮$N的問題。",
     "$n認真考慮$N的問題。", "$n認真考慮你的問題。", "你認真考慮著自己的未來。",
     "$n認真考慮著$e的未來。"},
    /*
        {
            "possum",
    ...
    */
    ...
    /*
        ...
        },
        {
            ...
            "$n pretends $e is a GOD, and says, '$N, you're demoted to level
       1!'",
            "$n pretends $e is a GOD, and says, 'You are demoted to level 1!'",
            "You pretend you are an implementor, and you demote yourself to
       level 1.",
    ...
    {"pull", "Pull 誰？", "", "你拉著$N的袖子，捨不得讓$E離開。",
     "$n拉著$N的袖子，捨不得讓$E離開。", "$n拉著你的袖子，捨不得讓你離開。",
     "你拉了拉自己的衣袖。", "$n拉了拉$e自己的衣袖。"},

    {"punch", "Punch 誰？", "", "你一拳打在$N的肚子上，爽啊！",
     "$n一拳打在$N的肚子上。", "$n一拳打在你的肚子上，好痛！",
     "你反手一拳，把自己打得倒在地上。", "$n反手一拳，把$e自己打得倒在地上。"},
    /*
        {
            "purr",
    ...
    */
    {"quick", "你著急的說：「快點呀，不然就來不及了。」",
     "$n著急的說：「快點呀，不然就來不及了。」",
     "你狠狠地催促著$N：「你動作快點好不好啊！」",
     "$n狠狠地催促著$N：「你動作快點好不好啊！」",
     "$n狠狠地催促著你：「你動作快點好不好啊！」",
     "你對自己的反應迅速感到很滿意。", "$n對$e自己的反應迅速感到很滿意。"},
    ...
    /*
...

        {
            ...
            "You exclaim, 'Oh Happy Happy, Joy Joy!' at the mere thought of
       $M.",
            "$n exclaims, 'Oh Happy Happy, Joy Joy!' as $e sees $N enter the
       room.",
            "$n exclaims, 'Oh Happy Happy, Joy Joy!' when $e sees you
       approach.", "You exclaim, 'Oh Happy Happy, Joy Joy!' at the thought of
       yourself.",
    ...
    */
    {"ruffle", "你撥了撥被風吹亂的頭髮。", "$n撥了撥被風吹亂的頭髮。",
     "你替$N撥了撥被風吹亂的頭髮。", "$n替$N撥了撥被風吹亂的頭髮。",
     "$n替你撥了撥被風吹亂的頭髮。", "", ""},
    /*
        {
            "russian",
        ...
        */
    {"sad", "你難過地掉下淚來。", "$n難過地掉下眼淚。",
     "你望著$N，心中一陣酸楚，眼淚不禁奪眶而出。",
     "$n神情難過的望著$N，眼淚奪眶而出。", "$n神情難過的望著你，眼淚奪眶而出。",
     "", ""},

    {"salute", "你瀟灑地行了個舉手禮。", "$n瀟灑地行了個舉手禮。",
     "你對$N行了個舉手禮。", "$n對$N行了個舉手禮。", "$n對你行了個舉手禮。",
     "Huh?", ""},
    /*
        {
            "scold",
    ...
    */
    ...
    {"shake", "你搖了搖頭。", "$n搖了搖頭。", "你對$N搖了搖頭。",
     "$n對$N搖了搖頭。", "$n對你搖了搖頭。", "", ""},

    {"shiver", "你冷的發抖！", "$n冷的發抖！", "你害怕$N而發抖。",
     "$n害怕$N而發抖。", "$n對著你直發抖，看起來好像很怕你。",
     "你縮著身子，發抖著說：「人家好怕好怕哦～」",
     "$n縮著身子，發抖著說：「人家好怕好怕哦～」"},

    {"shrug", "你無奈地聳了聳肩。", "$n無奈地聳了聳肩。",
     "你對著$N無奈地聳了聳肩。", "$n對著$N無奈地聳了聳肩。",
     "$n對著你無奈地聳了聳肩。", "", ""},

    {"sigh", "你長長的嘆了一口氣，「唉～～」", "$n長長的嘆了一口氣。",
     "你對著$N長長的嘆了一口氣。", "$n對著$N長長的嘆了一口氣。",
     "$n對著你長長的嘆了一口氣。", "", ""},

    {"sing", "你高興地哼起了小調.", "$n高聲地唱起歌來.",
     "你對$N愉快的哼著那首動聽的小調.", "$n對$N唱著：「你快樂嗎？我很快樂！」",
     "$n對你唱著：「你快樂嗎？我很快樂！」",
     "你一邊作其他事，一邊對自己哼著歌。",
     "$n一邊作其他事，一邊對自己哼著歌。"},
    ...
    */
    ...
    {"smile", "你愉快的笑著。", "$n愉快的笑著。", "你對$N愉快的微笑著。",
     "$n對$N露出愉快的神情。", "$n對你愉快的笑著。", "", ""},
    {"smoking", "你輕輕吸了口煙，吐了個煙圈，眼神飄向遠方...",
    ...
    {"smirk", "你不屑地笑了一聲。", "$n不屑地笑了一聲。",
     "你覺得$N的話真是可笑。", "$n覺得$N的話真是可笑。",
     "$n覺得你的話真是可笑。", "你覺得你自己看起來很可笑。",
     "$n看起來很可笑。"},
    {"sm!", "你從身上拿出皮鞭、蠟蠋，開始尋找對象....",
    ...
    */
    {"sneeze", "你打了一個噴嚏，「哈啾～」", "$n打了一個噴嚏。", "", "", "", "",
     ""},

    {"snicker", "你躲在一旁偷偷的笑。", "$n躲在一旁偷偷的笑。",
     "你背對著$N，躲在一旁偷偷的笑。", "$n背對著$N，躲在一旁偷偷的笑。",
     "$n背對著你，躲在一旁偷偷的笑。",
     "你突然有了一個邪惡的念頭，於是偷偷的笑了起來。",
     "$n突然偷偷笑了起來，一定有什麼不對勁。"},

    {"sniff", "你低聲啜泣。", "$n低聲啜泣。", "你對著$N不停地哭哭啼啼。",
     "$n對著$N不停地哭哭啼啼。", "$n對著你不停地哭哭啼啼。",
     "你一個人躲在黑暗的角落，一副爺爺不疼，姥姥不愛的樣子。",
     "$n一個人躲在黑暗的角落，一副爺爺不疼，姥姥不愛的樣子。"},

    {"snore", "你大聲的打呼：「Zzzzzzzzzzzzzzzzz」", "$n大聲的打呼。", "", "",
     "", "", ""},

    {"snowball", "Snowball 誰？", "", "你朝$N臉上丟了一顆雪球。",
     "$n朝$N臉上丟了一顆雪球。", "$n朝你臉上丟了一顆雪球。",
     "你朝自己臉上丟了一顆雪球。", "$n朝$e自己臉上丟了一顆雪球。"},

    {"snuggle", "你揉揉眼睛，一副想睡覺的樣子。",
     "$n揉揉眼睛，一副想睡覺的樣子。", "", "", "", "", ""},

    {"sob", "你輕聲啜泣。", "$n不停地哭哭啼啼。",
     "你靠在$N懷裡不停地哭哭啼啼。", "$n靠在$N懷裡不停地哭哭啼啼。",
     "$n靠在你懷裡不停地哭哭啼啼。", "", ""},
    {"soga", "你點了點頭，露出恍然大悟的表情。",
     "$n點了點頭，臉上一副「原來如此」的表情。", "", "", "", "", ""},
    {"sorry", "你感到很抱歉。", "$n感到很抱歉。", "你對$N鄭重的道歉。",
     "$n對$N鄭重的道歉。", "$n對你鄭重的道歉。", "你覺得你愧對全世界。",
     "$n覺得自己愧對全世界。"},

    {"spank", "Spank 誰？", "", "你狠狠地朝$N的屁股打了一下，痛的$E跳了起來。",
     "$n狠狠地朝$N的屁股打了一下，痛的$E跳了起來。",
     "$n狠狠地朝你的屁股打了一下，痛的你跳了起來。",
     "你揍了一下自己的屁股，好痛！", "$n揍了一下自己的屁股。"},
    /*
        {
            "spin",
    ...
    */
    {"stare", "你用一種異樣的眼神掃視著在場的每一個人。",
     "$n用一種異樣的眼神掃視著在場的每一個人。",
     "你突然轉過頭去，朝$N狠狠瞪了一眼。", "$n突然轉過了頭，朝$N狠狠瞪了一眼。",
     "$n突然轉過頭來，朝你狠狠瞪了一眼。",
    ...
    /*
        {
            ...
            "$n holds $s weapon to $s throat and says 'Ok, me, give me all my
       money!'"
        },
...

        {
            ...
            "$n shows $s bare shoulder and glances seductively around the
       room.", "You show some of your shoulder as you begin your performance.",
        ...
        */
    {"sweat", "你擦了擦額頭上的汗水。", "$n擦了擦額頭上的汗水。",
     "你替$N擦了擦額頭上的汗水。", "$n替$N擦了擦額頭上的汗水。",
     "$n替你擦了擦額頭上的汗水。", "", ""},
    /*
        {
          "sweep",
...

        {
            ...
            "You wrap your arms around yourself, and throw yourself to the
       ground.",
    ...
    */
    ...
    {"tender", "你溫柔的說：「沒關係！」", "$n溫柔的說：「沒關係！」",
     "你對$N投以關愛的眼神。", "$n對$N投以關愛的眼神。",
     "$n對你投以關愛的眼神。", "你唱道：「我不醜～而且我很溫柔～」",
     "$n唱道：「我不醜～而且我很溫柔～」"},

    {"thank", "你對在場的所有人道謝！", "$n對在場的所有人道謝！",
     "你衷心地對$N表達感謝之意。", "$n衷心地對$N表達感謝之意。",
     "$n衷心地對你表達感謝之意。", "謝你自己？", ""},

    {"think", "你低頭沉思。", "$n低頭沉思。", "你認真考慮$N的問題。",
     "$n認真考慮$N的問題。", "$n認真考慮你的問題。", "你認真考慮著自己的未來。",
     "$n認真考慮著$e的未來。"},

    {"thirsty", "你有氣無力的喊道：「水～給我水～」",
     "$n有氣無力的喊道：「水～給我水～」", "", "", "", "", ""},
    /*
      {
          "throttle",
  ...
  */
    {"tickle", "Tickle 誰？", "", "你伸手到$N的胳肢窩下面，弄得$E笑個不停。",
    ...
    /*
...

        {
            ...
            "$n tortures $mself with rusty weapons.	 Looks like $e enjoys
       it!?"
        },
...

        {
            ...
            "$n couldn't type a period if there was only one key on the
       keyboard.", "You throw up yor handz in dizgust at yur losy typing
       skils.",
            "$n couldn't type a period if there was only one key on the
       keyboard.",
            "$n couldn't type a period if there was only one key on the
        ...
        */
    {"tsk", "你嘖嘖稱奇。", "$n嘖嘖稱奇。", "你對著$N嘖嘖稱奇。",
     "$n對著$N嘖嘖稱奇。", "$n對著你嘖嘖稱奇。",
     "你不停地發出嘖、嘖、嘖的聲音。", "$n不停地發出嘖、嘖、嘖的聲音。"},

    {"understand", "你點了點頭，露出恍然大悟的表情。",
     "$n點了點頭，臉上一副「我懂了」的表情。",
     "你眼露兇光，對$N說：「看來，一切你都知道了？」",
     "$n眼露兇光，對$N說：「看來，一切你都知道了？」",
     "$n眼露兇光，對你說：「看來，一切你都知道了？」",
     "你覺得這個世界上沒有別人瞭解你。", "$n覺得這個世界上沒有人能瞭解$e。"},

    {"viva", "你大喊一聲：「萬歲！」", "$n大喊一聲：「萬歲！」",
     "你萬分恭敬地朝$N跪拜下去，高呼：「萬歲，萬歲，萬萬歲！」",
     "$n萬分恭敬地朝$N跪拜下去，高呼：「萬歲，萬歲，萬萬歲！」",
     "$n萬分恭敬地朝你跪拜下去，高呼：「萬歲，萬歲，萬萬歲！」", "", ""},

    {"waggle", "Waggle 誰？", "", "你對$N搖搖手指：「小朋友，這樣不好哦！」",
     "$n對$N搖搖手指：「小朋友，這樣不好哦！」",
     "$n對你搖搖手指：「小朋友，這樣不好哦！」", "", ""},
    {"wait", "你在原地坐了下來，開始等待。", "$n在原地坐了下來，開始等待。",
     "你在原地坐了下來，開始等$N。", "$n在原地坐了下來，開始等$N。",
     "$n在原地坐了下來，開始等你。", "你耐心的等待著升42級的時候到來。",
     "$n耐心的等待著升42級的時候到來。"},

    {"wave", "你揮了揮手。", "$n揮了揮手。", "你對$N揮手道別。",
     "$n對$N揮手道別。", "$n對你揮手道別。", "要離開遊戲，用QUIT比較快。", ""},

    {"weak", "你看起來楚楚可憐的，生怕別人欺負你。",
     "$n看起來楚楚可憐的，你們不會欺負$e吧？",
     "你囂張地對$N說：「哼！回去練一百年再來跟我交手吧！」",
     "$n囂張地對$N說：「哼！回去練一百年再來跟我交手吧！」",
     "$n囂張地對你說：「哼！回去練一百年再來跟我交手吧！」", "", ""},

    {"welcome", "你代表天神歡迎大家來到這個世界。",
     "$n代表天神歡迎大家來到這個世界。",
     "你對$N說：「別客氣，今天我請客，盡量吃。」",
     "$n對$N說：「別客氣，今天我請客，盡量吃。」",
     "$n對你說：「別客氣，今天我請客，盡量吃。」",
    ...
    {"whistle", "你愉快地吹著口哨。", "$n愉快地吹著口哨。",
     "你對$N大聲的吹著口哨。", "$n對$N大聲的吹著口哨。",
     "$n對你大聲的吹著口哨。", "你吹著口哨，自得其樂。",
     "$n吹著口哨，自得其樂。"},
    /*
        {
            "wedgie",
...

        {
            ...
            "$n whines 'I want to be a god already.	 I need more
       hitpoints..I...'", "You whine to $M like the great whiners of the
       century.",
            "$n whines to $N 'I want to be an immortal already.  I need more
       hp...I..'",
            "$n whines to you 'I want to be an immortal already.  I need more
       hp...I...'", "You whine like the great whiners of the century.",
            "$n whines 'I want to be a god already.	 I need more
       hitpoints..I...'"
        },
    ...
    */
    {"wink", "你眨了眨眼睛！", "$n眨了眨眼睛！", "你對$N眨了眨眼睛！",
     "$n對$N眨了眨眼睛！", "$n對你眨了眨眼睛！", "對自己眨眼？看得到嗎？", ""},
    /*
        {
            "wish",
    ...
    */
    ...
    {// by skalt@ROC
     "worm", "你像隻蟲般在地上蠕動著。", "$n像隻蟲般在地上蠕動著。",
     "你悄悄地把毛毛蟲丟到了$N的衣服裡。", "$n悄悄地把毛毛蟲丟到了$N的衣服裡。",
     "$n悄悄地把毛毛蟲丟到了你的衣服裡。",
     "你大叫一聲，試著抓出在背上移動的蟲蟲。",
...
*/
    {"worry", "你突然感到莫名的擔心！", "$n突然感到莫名的擔心！",
     "你對$N苦口婆心地說：「孩子，你這樣實在讓人很擔心耶。」",
     "$n對$N苦口婆心地說：「孩子，你這樣實在讓人很擔心耶。」",
     "$n對你苦口婆心地說：「孩子，你這樣實在讓人很擔心耶。」",
     "你對自己的狀況感到很擔心。", "$n對$e自己的狀況感到很擔心。"},

    {"ya", "你露出勝利的表情，「YA～！」", "$n露出勝利的表情，「YA～！」",
     "你對$N露出勝利的表情，「YA～！」", "$n對$N露出勝利的表情，「YA～！」",
     "$n對你露出勝利的表情，「YA～！」", "", ""},

    {"yabba", "YABBA-DABBA-DOO!", "$n 大喊著 '嘿！威瑪 -- YABBA DABBA DOO!'",
     "你大喊著 '嘿！$N -- YABBA DABBA DOO!'",
     "$n 大喊著 '嘿！$N -- YABBA DABBA DOO!'",
     "$n 大喊著 '嘿！$N -- YABBA DABBA DOO!'", "YABBA-DABBA-DOO!",
    ...
    {"yawn", "你「呵～」的一聲，打了一個哈欠。",
     "$n「呵～」的一聲，打了一個哈欠。", "你「呵～」的一聲，對$N打了一個哈欠。",
     "$n「呵～」的一聲，對$N打了一個哈欠。",
     "$n「呵～」的一聲，對你打了一個哈欠。", "", ""},

    {"tea", "你趁著閒來無事的時候沏了一壺好茶，聞著茶香好不悠哉～",
    ...
    {"oldbie", "你對著大家神氣的說：「我是老手～需要幫忙找我就對了！」",
     "$n對著大家神氣的說：「我是老手～需要幫忙找我就對了！」",
     "你將$N放進骨灰罈中，擺到神壇上開始祭拜。",
     "$n將$N放進骨灰罈裡，擺在神桌上虔誠的祭拜著。",
     "$n把你當成骨灰擺到神桌上，對著你虔誠的祭拜著。",
     "你對著大家狂笑道：「跟我這個老手比，你們都太嫩了啊！」",
     "$n對著大家狂笑道：「跟我這個老手比，你們都太嫩了啊！」"},

    {"avert", "你緩緩將目光轉移，假裝什麼都沒看到。",
    ...
    {"strut", "你趾高氣昂地晃來晃去。", "$n趾高氣昂地晃來晃去。",
     "你得意的在$N面前晃來晃去。", "$n得意的在$N面前晃來晃去。",
     "$n得意的在你面前晃來晃去, 一副很欠扁的樣子。",
     "你意氣風發的在這兒來回踱步。", "$n意氣風發的在這兒來回踱步。"},

    {"fossil", "你四處挖掘, 並且喃喃地唸著「這邊不知道有沒有化石呢？」",
     "$n四處挖掘, 把這地方挖得一個洞一個洞地。",
     ...
     "你大聲地喊著「不要再叫我化石了 >_<」",
     "$n大聲地喊著「不要再叫我化石了 >_<」"},
    {"tear", "你抬起頭，默默地看著天空, 眼淚不由自主的流下....。",
     "$n抬起頭，默默地看著天空, 眼淚不由自主的流下....。",
     "你拿起手帕，溫柔的幫$N拭去眼角的淚痕....。",
     "$n拿起手帕，溫柔的幫$N拭去眼角的淚痕....。",
     "$n拿起手帕，溫柔的幫妳拭去眼角的淚痕....。",
     "你低下頭來，擦擦自己眼角的淚水....。",
     "$n低下頭來，擦擦自己眼角的淚水....。"},
    {"pant", "你滿身大汗，滿臉通紅地大聲喘氣。",
     "$n滿身大汗，滿臉通紅的大聲喘氣。", "你滿臉通紅地在$N的耳邊輕輕地喘息。",
     "$n滿臉通紅的朝著$N的耳邊喘氣。", "$n滿臉通紅地在你的耳邊輕輕地喘息。",
     "你紅著臉，盡力壓抑著自己的喘息。", "$n紅著臉，盡力壓抑著自己的喘息。"},
    {"kneel", "你驚恐的跪下，大聲地說：「奴才下次不敢了！」",
     "$n驚恐的跪下，大聲地說：「奴才下次不敢了！」",
     "你恭敬地單膝跪在$N的面前，親吻他的手背。",
     "$n恭敬地單膝跪在$N的面前，親吻他的手背。",
     "$n恭敬地在你面前單膝跪下，親吻你的手背。",
     "你頂著水桶，面對牆角跪在算盤上。", "$n頂著水桶，對著牆角跪在算盤上。"},
    {"angel", "你神情哀怨地說道：「我還在尋找屬於我的天使... 」",
     "$n神情哀怨地說道：「我還在尋找屬於我的天使... 」",
     "你突然覺得$N就像天使，不禁激動地握住她的雙手說道：「$"
     "N，你真是我的天使！」",
     "$n突然不發一語地握住$N的雙手，以戀慕的神情對它說道：「$"
     "N，你是我的天使！」",
     "$n猛然不發一語地握住你的雙手，神情戀慕地對你說道：「$N，你是我的天使！」",
     "在這一瞬間，你覺得自己像天使一般神聖純潔。",
     "在你身旁的$n突然覺得她自己像天使一般神聖純潔。"},
    {"niceman", "你放聲大喊：「有沒有人要加入好人俱樂部啊！」",
     "$n放聲大喊：「有沒有人要加入好人俱樂部啊！」",
     "你帶著歉疚的神情對$N說：「你是一個好人....」",
    ...
    {"impossible", "你覺得世界上不會有這種事情發生。",
     "$n皺著眉頭說：「不可能吧 ...。 」", "根據你的經驗，你覺得$N辦不到。",
     "$n好心地勸$N說：「不可能吧 ...。 」",
     "$n對你分析事情的真相，你開始對自己的信心動搖了。",
     "你覺得這種事不會發生在你身上。",
     "$n對自己說：「這種事對我來說是沒可能的呀。」"},
    {"cantbe", "你開始害怕事情已經不是你所能想像的。",
     "$n非常不能接受地說：「不...不會吧...。」", "你開始對$N起了疑心。",
     "$n不懷好意地對$N說：「該不會是你吧 ...。」",
     "$n不懷好意地對你說：「該不會是你吧 ...。」",
     "你怎麼開始懷疑起自己來了？！",
     "$n吞吞吐吐地說：「不 ... 不會是我吧 .. 。」"},
    {"nosmoking", "你開始大聲宣揚著拒吸測試二手煙的理念。",
     "$n開始大聲宣揚著拒吸二手煙的理念。",
...
bool check_social(CHAR_DATA *ch, char *command, char *argument) {
    ...
    if (arg[0] == '\0') {
        ...
        if (!IS_NPC(ch) && IS_NPC(victim) && !IS_AFFECTED(victim, AFF_CHARM) &&
            ...
            case 11:
            case 12:
                act("你狠狠地打了$N幾個耳光，打的$E整張臉都腫了起來。", victim,
                    NULL, ch, TO_CHAR);
                act("$n狠狠地打了你幾個耳光，打的你整張臉都腫了起來。", victim,
                    NULL, ch, TO_VICT);
                act("$n狠狠地打了$N幾個耳光，打的$E整張臉都腫了起來。", victim,
                    NULL, ch, TO_NOTVICT);
                break;
            }
        }
