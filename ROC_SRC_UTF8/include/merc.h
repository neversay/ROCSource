...
//*  PURPOSE     :         在 struct char_data 中加入變數         *
//*              :         time_t time_stamp                      *
//*---------------------------------------------------------------*
//*  MODIFY  BY  : 0940908 Razgriz                                *
//*  PURPOSE     :         新增 check_exit() 函數宣告             *
//*---------------------------------------------------------------*
//*  MODIFY  BY  : 0940914 jye                                    *
//*  PURPOSE     :         新增do_mpget mob_commands              *
//*---------------------------------------------------------------*
//*  MODIFY  BY  : 0940915 Razgriz                                *
//*  PURPOSE     :         新增 do_mpset_obj_affect    函數宣告   *
//*              :         新增 do_mpremove_obj_affect 函數宣告   *
//*---------------------------------------------------------------*
//*  MODIFY  BY  : 0940916 Razgriz                                *
//*  PURPOSE     :         新增 do_mpmodify_obj_affect 函數宣告   *
//*---------------------------------------------------------------*
//*  MODIFY  BY  : 0940916 Razgriz                                *
//*  PURPOSE     :         新增 do_opset_obj_affect    函數宣告   *
//*              :         新增 do_opremove_obj_affect 函數宣告   *
//*              :         新增 do_opmodify_obj_affect 函數宣告   *
//*---------------------------------------------------------------*
//*  MODIFY  BY  : 0940916 Razgriz                                *
//*  PURPOSE     :         新增 do_forceo 函數宣告                *
//*---------------------------------------------------------------*
//*  MODIFY  BY  : 0940918 Razgriz                                *
//*  PURPOSE     :         新增 struct obj_extra_value            *
//*              :         在 obj_data 中加入 extra_value 變數    *
//*---------------------------------------------------------------*
//*  MODIFY  BY  : 0940918 Razgriz                                *
//*  PURPOSE     :         新增 do_opmodvt 函數宣告               *
//*---------------------------------------------------------------*
//*  MODIFY  BY  : 0940921 Razgriz                                *
//*  PURPOSE     :         新增 obj_find  函數宣告                *
//*---------------------------------------------------------------*
//*  MODIFY  BY  : 0940921 Razgriz                                *
//*  PURPOSE     :         新增 do_mpforceo  函數宣告             *
//*****************************************************************
...
#define TO_VICT			    2
#define TO_CHAR			    3
#define TO_ROOM_IMM			4//1050619 add TO_ROOM_IMM 只給room中的imm看
...
struct char_data
{
    ...
    time_t save_time;
    time_t last_note;
	int stay_time; // 判定在同個房間停留時間 2023/01/15
    int timer;
    int wait;
    int hit;
    int max_hit;
 ...
 * - 使用在 mone_hit() 的參數列中, 來區別是否要呼叫 dam_message()
 * - 使用在 damage()   的參數列中, 來區別是否要呼叫 dam_message()
 */
#define MSG_NORMAL	0
#define MSG_BRIEF	1
...
/*
 * Added by Razgriz 20051014
 * 使用在 damage() 的參數列中, 用來區別 傷害輸出時有不同判斷:
 * - 技能是否可被 parry dodge block statics
 * - 傷害是否無視聖光, 無視天使加護術
 */
#define DMG_NORMAL	0
#define DMG_ADJUST	1
...
/*
 * Added by Razgriz 20051014
 * 使用在 mone_hit() 的參數列中, 決定是否要改變呼叫端的 bt 值
 */
...
void scout args( ( CHAR_DATA *ch, EXIT_DATA *pexit, ROOM_INDEX_DATA *to_room , int sklv ) ); // 樓 sklv 2022/12/22
...
bool is_real_npc args( ( CHAR_DATA *ch ) ); /** zcecil, 檢查mob是不是非自主狀態 */
...
int get_curr_size args( ( CHAR_DATA *ch ) ); // 體型 2022/12/23
...
OD *get_char_obj args( ( CHAR_DATA *ch, char *argument ) ); // obj 2023/01/08
OD *get_obj_here args( ( CHAR_DATA *ch, char *argument ) );
OD *get_room_obj args( ( ROOM_INDEX_DATA *pRoomIndex, char *argument ) ); //  2023/01/08
OD *get_obj_world args( ( CHAR_DATA *ch, char *argument ) );
OD *get_obj_index_vnum args( (int vnum) );
int count_obj_index_vnum args( (int vnum) );
OD *check_using_wp args( ( CHAR_DATA *ch, int dt , int wield ) ); //  2022/12/25
OD *check_using_wp2 args( ( CHAR_DATA *ch, int dt ) ); //  2022/12/25
OD *create_money args( ( int amount ) );
int get_obj_number args( ( OBJ_DATA *obj ) );
int get_obj_weight args( ( OBJ_DATA *obj ) );
bool room_is_dark args( ( ROOM_INDEX_DATA *pRoomIndex ) );
//bool room_is_private args( ( ROOM_INDEX_DATA *pRoomIndex ) );
bool room_is_private args( ( CHAR_DATA *ch, ROOM_INDEX_DATA *pRoomIndex ) ); // 2022/12/20
