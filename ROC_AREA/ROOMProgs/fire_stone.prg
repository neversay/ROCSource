>room_defun fire_stone~
echo ¥|­±ªºÀð¾À¤£®É¼Q¥Xºµºµªº¯Pª¢!
if rand(20)
	rcall fire_catch
endif
if rand(30)
...
~
>room_command push stone~
if isfight($n)
	echoat $n §AÁÙ¦b¾Ô°«¤¤¡A¨S¦³®É¶¡¥h±À°Ê¥Û¶ô¡I
else
	echoat $n ·í§A±À°Ê¥Û¶ôªº¦P®É¡A¤@°}²r¯Pªº¤õª¢±qÀð¾À¼Q¥X¨Ó¡I
	echoaround $n ·í$N±À°Ê¥Û¶ôªº¦P®É¡A¤@°}²r¯Pªº¤õª¢±qÀð¾À¼Q¥X¨Ó¡I
	rcall fire_check
...
if rand(10)
	echoat $r ²r¯Pªº¤õª¢Åý§A [1;35m¦³¨ÇÀ¿¶Ë[m!(41-60)
	echoaround $r ²r¯Pªº¤õª¢Åý$R [1;35m¦³¨ÇÀ¿¶Ë[m!
	modhmv $r 01.41 60 0
	break
endif
if rand(20)
	echoat $r ²r¯Pªº¤õª¢Åý§A [1;35m¶}©l¯}¥Ö[m!(61-85)
	echoaround $r ²r¯Pªº¤õª¢Åý$R [1;35m¶}©l¯}¥Ö[m!
	modhmv $r 01.61 85 0
	break
endif
if rand(30)
	echoat $r ²r¯Pªº¤õª¢Åý§A [1;35m¯Q«C·ï¦å[m!(86-115)
	echoaround $r ²r¯Pªº¤õª¢Åý$R [1;35m¯Q«C·ï¦å[m!
	modhmv $r 01.86 115 0
	break
endif
if rand(40)
	echoat $r ²r¯Pªº¤õª¢Åý§A [1;35m* ¯Q«C·ï¦å *[m!(116-150)
	echoaround $r ²r¯Pªº¤õª¢Åý$R [1;35m* ¯Q«C·ï¦å *[m!
...
if rand(90)
	...
	echoat $r ²r¯Pªº¤õª¢¥´±o§A [1;32m**** ÂA¦åª½¬y ****[m.(381-450)
	echoaround $r ²r¯Pªº¤õª¢¥´±o$R [1;32m**** ÂA¦åª½¬y ****[m.
